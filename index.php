...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css" integrity="sha384-GJzZqFGwb1QTTN6wy59ffF1BuGJpLSa9DkKMp0DgiMDm4iYMj70gZWKYbI706tWS" crossorigin="anonymous">    <!-- Pogo Slider CSS -->
...
<div class="bottom-right" >
	<span class="fa fa-comments fa-5x bot" onClick="window.open('bot.php', '_blank','toolbar=no,addressbar=no,scrollbars=yes,resizable=no,top=10,left=500,width=400,height=600');"></span><br>
<!--	<span class="button-text">Inquiry Bot</span>-->
	</div>
	   ...
	   <div class="container">
	      <div class="row">
		      <div class="col-md-12">
			     <div class="tab_menu">
				    <ul>
					   <li><a href="#"><span class="icon"><img src="images/i1.png" alt="#" /></span><span>School Life</span></a></li>
					   <li><a href="#"><span class="icon"><img src="images/i2.png" alt="#" /></span><span>WASSCE</span></a></li>
...
-->
			  ...
			  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
			       <div class="footer_blog footer_menu white_fonts">
						    ...
						    <ul> 
							  ...
							  <li><a href="admin/" target="_blank">> Bot </a></li>
							</ul>
    ...
    <div class="footer_bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="crp">© Copyrights 2021 UPSA Project Work</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>	<script src="js/popper.min.js"></script>
-->
